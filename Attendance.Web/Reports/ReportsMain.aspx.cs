...
namespace MvcApplication1.Reports
{
    ...
    private void BindChart()
    {
        ...
        data.addRows(" + dt.Rows.Count + ");");
            ...
            str.Append(" chart.draw(data, {width: 700, height: 500, title: 'Vineyard Tri-County Auditorium Attendance',");
